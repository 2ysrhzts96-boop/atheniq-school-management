  ...
  return (
    <AppLayout pageTitle="Student Profile">
      ...
      <Card className="border-slate-200 shadow-sm overflow-hidden">
        <div className="h-32 bg-gradient-to-r from-[#1e2a4a] to-[#0d9488]"></div>
        <CardContent className="px-8 pb-8 pt-0 relative">
          <div className="flex flex-col md:flex-row gap-6 items-start md:items-end -mt-12 mb-6">
            ...
            <div className="flex gap-3 pb-2 w-full md:w-auto">
              <Button className="bg-[#0d9488] hover:bg-[#0d9488]/90 text-white flex-1 md:flex-none">
            ...
            <CardContent className="pt-4 space-y-4 text-sm">
              <div>
                ...
                <p className="font-medium text-slate-800 flex items-center gap-2">
                  <CalendarIcon size={16} className="text-slate-400" /> {studentData.dob}
                </p>
              </div>
              <div>
          ...
          <Card className="border-slate-200 shadow-sm">
            ...
            <CardContent className="pt-4 space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-slate-800 flex items-center gap-2">
                  <Phone size={16} className="text-slate-400" /> {studentData.parentPhone}
                </p>
              </div>
              <div>
                <p className="text-slate-500 mb-1">Email</p>
                <p className="font-medium text-slate-800 flex items-center gap-2">
                  <Mail size={16} className="text-slate-400" /> {studentData.parentEmail}
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <Tabs defaultValue="academic" className="w-full">
                <div className="border-b border-slate-100 px-6">
                  <TabsList className="h-14 bg-transparent w-full justify-start gap-6 rounded-none p-0">
                    <TabsTrigger 
                      value="academic" 
                      className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#0d9488] data-[state=active]:bg-transparent data-[state=active]:shadow-none font-medium h-14 px-2"
                    >
                      Academic History
                    </TabsTrigger>
                    <TabsTrigger 
                    ...
                    <table className="w-full text-sm text-left">
                      <thead className="bg-slate-50 text-slate-500 border-b border-slate-200">
                        <tr>
                          ...
                          <th className="px-4 py-3 font-medium text-center">Term 1</th>
                          <th className="px-4 py-3 font-medium text-center">Term 2</th>
                        ...
                        {gradesData.map((grade, i) => (
                          <tr key={i} className="hover:bg-slate-50/50">
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className="inline-block min-w-8 font-semibold text-[#0d9488]">{grade.term1}</span>
                            </td>
                            <td className="px-4 py-3 text-center">
                              <span className="inline-block min-w-8 font-semibold text-[#0d9488]">{grade.term2}</span>
                            </td>
